...
| [**Sistema de Biblioteca**](https://github.com/Rnchx/Sistema-biblioteca-PI2) | Sistema de gerenciamento de biblioteca com controle de empréstimos, devoluções e cadastro de usuários e livros. Foco na implementação de regras de negócio e operações CRUD. | JS, HTML, CSS, NodeJs, MySql  |
